...
knitr::opts_chunk$set(echo = FALSE, fig.width = 6, fig.height = 4,out.extra = "",dev=c('pdf'))

# save figures also as pdf
knitr::opts_chunk$set(dev = c('pdf'), 
        pdf.options(encoding = "ISOLatin9.enc")) 


setwd('~/opt/stride-308/')
# load rStride
...
```{r fig.cap='Infectiousness profile relative to symptom onset, from He et al (2020, Nat Med)'}
...
```{r fig.cap='Start infectious period'}
...
```{r fig.cap='Incubation period from Li et al (2020, NEJM)'}
# Incubation period ----
...
```{r fig.cap='Incubation period (discrete)' }
...
```{r fig.cap='Cumulative probability for the start of the infectious period', fig.height= 4}
...
```{r fig.cap='Infectious period (total)',fig.height= 3.5}
...
```{r fig.cap='Infectious period after symptom onset',fig.height= 3.5}
